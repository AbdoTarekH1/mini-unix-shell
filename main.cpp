...
int main() {
    ...
    while (true) {
        ...
        // LAB TEST HINT: If asked to change to "ATH-mini-shell:" in Magenta and Cyan, 
        // I will change this string to: "\033[1;35MATH-mini-shell:\033[1;36m"
        string prompt = "\033[1;35mATH1-mini-shell:\033[1;36m";
        ...
        // LAB TEST HINT: If updating the prompt colors to Cyan above, 
        // I just need to make sure this reset code (\033[0m) stays here at the end.
        prompt += "$ \033[0m";
